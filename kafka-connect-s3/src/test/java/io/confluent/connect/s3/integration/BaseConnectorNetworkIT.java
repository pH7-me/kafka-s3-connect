...
public abstract class BaseConnectorNetworkIT extends BaseConnectorIT {
  ...
  /**
   * Creates root client that will be used to change bucket permissions. Prerequisite : Access key
   * and Secret access key should be set as environment variables
   */
