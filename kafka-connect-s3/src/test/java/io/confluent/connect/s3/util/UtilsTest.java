...
public class UtilsTest {
  ...
  private static List<String> givenFilenames =
      new ArrayList<>(
          Arrays.asList(
              "x.avro",
              "asdf.avro",
  ...
  public void getAdjustedFilenameForValues() {
    ...
    for (int i = 0; i < expectedFilenames.size(); i++) {
      String adjustedFilename =
          getAdjustedFilename(new ValueRecordView(), givenFilenames.get(i), ".avro");
  ...
  public void getAdjustedFilenameForKeys() {
    ...
    for (int i = 0; i < expectedFilenames.size(); i++) {
      String adjustedFilename =
          getAdjustedFilename(new KeyRecordView(), givenFilenames.get(i), ".avro");
      assertEquals(expectedFilenames.get(i), adjustedFilename);
    }
  }
  ...
  public void getAdjustedFilenameForHeaders() {
    ...
    for (int i = 0; i < expectedFilenames.size(); i++) {
      String adjustedFilename =
          getAdjustedFilename(new HeaderRecordView(), givenFilenames.get(i), ".avro");
      assertEquals(expectedFilenames.get(i), adjustedFilename);
    }
  }
  ...
  public void testParquetEncodingExtensions() {
    ...
    for (int i = 0; i < expectedFilenames.size(); i++) {
      String adjustedFilename =
          getAdjustedFilename(new HeaderRecordView(), givenFilenames1.get(i), ".snappy.parquet");
      assertEquals(expectedFilenames.get(i), adjustedFilename);
    }
  }
}
